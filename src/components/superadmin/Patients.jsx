              ...
              return (
                <div key={key} className="p-4 hover:bg-gray-50">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div><span className="text-gray-500">Age:</span> <span className="text-gray-700">{calculateAge(p.dateOfBirth)}</span></div>
                    ...
                    <div><span className="text-gray-500">Blood:</span> <span className="text-gray-700">{p.bloodGroup || '—'}</span></div>
                    ...
                    <tr key={key} className="border-t border-gray-200 hover:bg-gray-50">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="font-medium text-gray-900 truncate max-w-[200px]">{p.fullName || '—'}</div>
                        </div>
                      </td>
                      <td className="px-4 py-3 font-mono text-gray-700 whitespace-nowrap">{p.patientCode || '—'}</td>
                      <td className="px-4 py-3 text-gray-700 whitespace-nowrap">{calculateAge(p.dateOfBirth)}</td>
                      ...
                      <td className="px-4 py-3 text-gray-700 whitespace-nowrap">{p.bloodGroup || '—'}</td>
